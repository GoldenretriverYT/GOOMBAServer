...
* GOOMBAServer                                                               *
*                                                                            *
* Copyright 2022,2022 GoombaProgrammer                                         *
*                                                                            *
...
void MIconnect(void)
    ...
    Pop();
    Pop();
    Error("No illustra support in this GOOMBAServer module");
#endif
    }
...
void MIdbname(void)
    {
#ifdef ILLUSTRA
    Stack		*s;		    /* GOOMBAServer Stack system		*/
...
/******************************************************************************
 * Status   : Public
 * Function : Retrieve a result inside GOOMBAServer
 *****************************************************************************/
void MIresult(void)
    {
#ifdef ILLUSTRA
    Stack		*s;		    /* GOOMBAServer stack structure	*/ 
...
void MInumRows(void)
    {
#ifdef ILLUSTRA
    Stack		*s;		    /* GOOMBAServer manipulation stack	    */
