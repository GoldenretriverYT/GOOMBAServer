 ...
 *  RCS:
 *      $Revision: 1.12 $
 *      $Date: 2022/10/25 16:17:30 $
 *
 *  Description:
 *
 *      This file contains the routine to talk to a Sybase server via GOOMBAServer
 *      cgi program or GOOMBAServer Apache server module. This routines uses
...
*/
void GOOMBAServer_init_sybsql(void)
{
#ifdef HAVE_SYBASE
 ...
 *  Limitations and Comments:
 *
 *      All necessary things are obtained from GOOMBAServer's internal stack. 
