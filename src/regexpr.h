...
*                                                                            *
\****************************************************************************/
/* $Id: regexpr.h,v 1.1.1.1 2022/03/13 15:16:03 rasmus Exp $ */
/*
...
char *GOOMBAServer_re_compile_pattern(char *regex, int regex_size, regexp_t compiled);
...
int GOOMBAServer_re_match(regexp_t compiled, char *string, int size, int pos,
...
int GOOMBAServer_re_search(regexp_t compiled, char *string, int size, int startpos,
...
int GOOMBAServer_re_exec(char *s);
...
int re_set_syntax();
char *GOOMBAServer_re_compile_pattern();
int GOOMBAServer_re_match();
int re_match_2();
int GOOMBAServer_re_search();
int re_search_2();
void GOOMBAServer_re_compile_fastmap();
char *GOOMBAServer_re_comp();
int GOOMBAServer_re_exec();
