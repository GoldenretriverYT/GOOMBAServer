...
typedef struct oraBindVar {     /*-== Variables Binding =--*/
        ...
        char*   GOOMBAServer_name;       /* Variable name in GOOMBAServer    */
...
static int         ora_bind_in();  /* Copy data from GOOMBAServer to bind holders */
static int         ora_bind_out(); /* Copy data from bind holders to GOOMBAServer */
