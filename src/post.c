...
#if APACHE	
/*	buf = GOOMBAServer_rqst->content_type; */
	buf = table_get(GOOMBAServer_rqst->subprocess_env,"CONTENT_TYPE");
#else
...
#if APACHE
	buf = table_get(GOOMBAServer_rqst->subprocess_env,"CONTENT_LENGTH");
#else
